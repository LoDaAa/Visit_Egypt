...
@Component({
  selector: 'app-sharm-el-sheikh',
  templateUrl: './sharm-el-sheikh.component.html',
  styleUrls: ['./sharm-el-sheikh.component.scss']
})
export class SharmElSheikhComponent implements OnInit {
